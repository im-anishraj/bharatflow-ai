...
- replace prototype testimonials with real approved customer quotes;
- replace placeholder company links and social profiles;
- review all legal pages with counsel;
- confirm the license path for commercial availability; and
- run a final search for Typebot trademarks outside legal provenance notices and internal package names.
