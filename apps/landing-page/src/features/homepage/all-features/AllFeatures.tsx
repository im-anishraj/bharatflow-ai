...
const cards = [
  {
    Icon: CodeIcon,
    title: "Prefilled context",
    description:
      "Carry campaign, branch, product, or CRM data into every workflow.",
    rotateCoeff: -10,
  },
  {
    Icon: UsersIcon,
    ...
    description:
      "Invite teams to build, review, and operate shared customer journeys.",
    rotateCoeff: 12,
  },
  {
    Icon: Link02Icon,
    ...
    description:
      "Connect lead, support, KYC, and handoff journeys without rebuilding.",
    rotateCoeff: -7,
  },
  {
    Icon: DocumentCodeIcon,
    title: "Custom code",
    description: "Extend workflows with your own Javascript, CSS, and logic.",
    rotateCoeff: -2,
  },
  {
    Icon: ZapIcon,
    title: "Custom domain",
    description: "Launch workflows on branded domains and embedded surfaces.",
    rotateCoeff: 2,
  },
  {
    Icon: DatabaseIcon,
    ...
    description:
      "Connect HTTP, AI providers, Google Sheets, analytics, CRMs, and more.",
    rotateCoeff: -4,
  },
] as const;
      ...
      <div className="md:overflow-visible flex flex-col items-center md:h-all-features-sticky-container">
        <div className="md:sticky flex flex-col md:justify-between items-center max-w-xl shrink-0 top-(--padding-top) md:h-(--header-height) gap-6 md:gap-0">
          <h2 className="px-4 text-center">
            All the primitives you need to run AI workflows
          </h2>
          <CtaButtonLink
            size="lg"
