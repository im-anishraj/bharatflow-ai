...
const stats = [
  {
    stat: "10",
    label: "India workflow templates",
  },
  {
    stat: "24/7",
    label: "WhatsApp-ready automation",
  },
  {
    stat: "DPDP",
    label: "aware journey design",
  },
];
      ...
      <div className="flex flex-col gap-12 md:items-center max-w-4xl">
        <div className="flex flex-col gap-6 text-balance md:text-center">
          <h2 className="text-gray-12">
            Built for serious teams modernizing
            <br className="hidden md:block" />
            customer operations in India
          </h2>
          <p className="text-gray-11">
            BharatFlow AI packages the speed of a visual builder with the
            control enterprises expect: consent-aware journeys, encrypted
            credentials, private deployment options, APIs, and workflows that
            keep AI focused on business tasks.
          </p>
        </div>
