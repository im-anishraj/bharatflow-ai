...
const features = [
  {
    title: {
      main: "Design every journey",
      sub: "turn business processes into governed workflows",
    },
    description:
  ...
  {
    title: {
      main: "Launch where India talks",
      sub: "deploy once across WhatsApp, web, and APIs",
    },
    description:
  ...
  {
    title: {
      main: "Prove business impact",
      sub: "measure conversion, SLA, and completion",
    },
    description:
      "Track starts, completions, drop-offs, answers, logs, and exports so every team can see which journeys convert, where customers get stuck, and what data should flow into the next business action.",
    video: {
