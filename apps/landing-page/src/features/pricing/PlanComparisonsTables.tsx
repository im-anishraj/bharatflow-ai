  ...
  <div className="flex flex-col gap-4">
    <TableRoot className="bg-card rounded-xl border">
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell className="pl-6">Total workflows</TableCell>
            <InfinityTableCell />
            <InfinityTableCell />
            <InfinityTableCell />
          </TableRow>
          ...
          <TableRow>
            <TableCell className="pl-6">Additional conversations</TableCell>
            <TableCell />
            <TableCell>Rs. 750 per 500 conversations</TableCell>
            <TableCell>
    ...
    <TableRoot className="bg-card rounded-xl border py-2">
      <Table>
        ...
        <TableBody>
          ...
          <TableRow>
            <TableCell>India workflow templates</TableCell>
            <CheckedTableCell />
            <CheckedTableCell />
            <CheckedTableCell />
          </TableRow>
          ...
          <TableRow>
            <TableCellWithTooltip tooltip="Organize your workflows into folders">
              Workspace folders
            </TableCellWithTooltip>
            <TableCell />
            <InfinityTableCell />
          ...
          <TableRow>
            <TableCell>WhatsApp workflow deployment</TableCell>
            <TableCell />
            <TableCell />
            <CheckedTableCell />
          </TableRow>
    ...
    <TableRoot className="bg-card rounded-xl border py-2">
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell>Private support</TableCell>
            <CheckedTableCell />
            <CheckedTableCell />
            <CheckedTableCell />
          </TableRow>
...
const PlanTableHeads = ({ className }: { className?: string }) => (
  <>
    <TableHead className={className}>LAUNCH</TableHead>
    <TableHead className={cn("text-primary", className)}>GROWTH</TableHead>
    <TableHead className={cn("text-violet-500", className)}>BUSINESS</TableHead>
  </>
);
