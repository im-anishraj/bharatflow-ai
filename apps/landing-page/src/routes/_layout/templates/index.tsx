...
export const Route = createFileRoute("/_layout/templates/")({
  head: () => ({
    meta: createMetaTags({
      title: "Workflow Templates | BharatFlow AI",
      description:
        "Browse India-ready workflow templates for WhatsApp lead qualification, support, document intake, appointments, payments, and feedback.",
