...
export const getServerSideProps: GetServerSideProps = async (
  ...
  try {
    ...
    if (isMatchingViewerUrl && pathname === "/") {
      ...
      return {
        props: {
          dashboardUrl: `${env.NEXTAUTH_URL ?? "https://app.bharatflow.ai"}/typebots`,
        },
      };
    }
    ...
    return (
      <ErrorPage
        error={
          errorCode === "OUTDATED"
            ? new Error(
                "This workflow is outdated. Please contact the administrator.",
              )
            : new Error("The workflow was not found")
        }
      />
    );
